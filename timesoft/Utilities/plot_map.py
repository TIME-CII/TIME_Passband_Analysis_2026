...
import timesoft.Utilities.coordinates as coords
import timesoft.Utilities.params as params
import timesoft.Utilities.mce_data as mce_data
...
def plot_maps(outfile, data=None, markers=None, title='',
    ...
    # Show markers
        ...
        for mc in markers_a.keys():
            plt.scatter(markers_a[mc], markers_b[mc], marker=mshape, s=msize, c=mc, norm=norm)

    if logscale:
        norm = matplotlib.colors.LogNorm()

    # Show values
    plt.scatter(val_a, val_b, marker=mshape, s=msize, c=val_c, cmap=cmap, norm=norm)
